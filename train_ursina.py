...
from vec_normalize_parallel import NormalizedEnv,NormalizedEnv_wrapper
...
def train_ppo(env,model,optimizer,normalizedEnv,writer,teacher,counter,image_args,args,device,ppo_trained_file_name,data_stat,model_dir):
    ...
    norm_envs_wrapper = NormalizedEnv_wrapper(norm_envs,np.zeros(shape=(1,args.text_input_length)).shape)
