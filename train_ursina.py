...
def train_ppo(env,model,optimizer,normalizedEnv,writer,teacher,counter,image_args,args,device,ppo_trained_file_name,data_stat):
    ...
    while True:
        ...
        if counter.iter_test >= args.test_steps:
            ...
            test_ursina(model,env,teacher,normalizedEnv,counter,args,image_args,device)
...
if __name__ == '__main__':
    ...
    normalizedEnv = NormalizedEnv(np.zeros(shape=(1,args.text_input_length)).shape,args.parallel_workers,args.depth_map_length)
